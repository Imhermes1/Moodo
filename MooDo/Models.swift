...
struct Task: Identifiable, Codable, Equatable {
    ...
    init(id: UUID = UUID(), title: String, description: String? = nil, isCompleted: Bool = false, isFlagged: Bool = false, isRecurring: Bool = false, priority: TaskPriority = .medium, emotion: TaskEmotion = .focused, category: TaskCategory = .personal, estimatedTime: Int? = nil, completedAt: Date? = nil, reminderAt: Date? = nil, deadlineAt: Date? = nil, naturalLanguageInput: String? = nil, list: TaskList? = nil, tags: [String] = [], subtasks: [Task]? = nil, eventKitIdentifier: String? = nil, createdAt: Date = Date(), isAIGenerated: Bool = false) {
        self.id = id
        self.title = title
